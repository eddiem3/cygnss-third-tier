     ...
     2 ibuff(32),ibuff2(32),icount,byht2
      ...
      INTEGER :: windsteps,windstart,windinc,ixsteps,ixinc,iysteps,
     1iyinc,ibsteps,ibinc,iasteps,iainc,iastart
*      real parmary(800,80)
...
*      open(unit=15,file='Cygwavegen.txt')
      open(unit=9,file='Cygbinary', form='UNFORMATTED',ERR=1000)
      write(*,*)
      write(*,*)'For Reference'
...
*
     ...
     1he true wind speed'
      ...
      read(*,*)bkgrdwnd
      write(*,*)     
      write(*,'(a30,i3,a4,i3,a6,i3,a10)')'The windspeed is stepped from
     1 ',windstart,'to', (wind
...
*      ibinc=0.25      
      ...
      iainc=10000
      iastart=50000
      write(9)windsteps,windstart,windinc,ixsteps,ixinc,iysteps,iyinc,
...
*     1(convary(kl),kl=1,600)
      write(9)i,j,k,l,m,wndspeed,xh*height,yh*height,A,B,Pdelt,
     1(convary(kl),kl=1,600)
