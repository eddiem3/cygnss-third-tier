     ...
     1 numslops,slopary,tanumax,xh,yh,A,B,Pdelt,height,numchips)
      implicit none
      integer n1,numslops,i,j,numchips
...
*
* Set up the values for u as a function of eye and outside the eye 
*
      ...
      c1=exp(-Abyht/(rsh**B))
      c2=(rho*(rsh**B))
      ut=sqrt(6.75*6.75+(Abyht*B*Pdelt*c1/c2))
      endif
