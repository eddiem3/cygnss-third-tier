     ...
     2 ibuff(32),ibuff2(32),icount,byht2
      INTEGER :: i,j,k,l,m,kl,kk,iall,nsamples,skewpeak,windsteps,
     1 windstart,windinc,ixsteps,ixinc,iysteps,iyinc,ibsteps,ibinc,
     2 iasteps,iastart,iainc
*      real parmary(800,80)
...
*      open(unit=15,file='Cygwavegen.txt')
      open(unit=15,file='Cygbinary', form='UNFORMATTED',ERR=1000)
      write(*,*)
      write(*,*)'For Reference'
      write(*,*)'The output file has icount,wndspeed,xh*height,yh*height
     1,A,B,Pdelt,kk,convary(kk)'
      write(*,*)
*      write(*,*)'The output file with the model waveforms is Cygwavege
*     1n.txt'     
      write(*,*)'The output file with the model waveforms is Cygbinary'
...
*
      ...
      iainc=10000
      iastart=50000
      write(15)windsteps,windstart,windinc,ixsteps,ixinc,iysteps,iyinc,
     1ibsteps,ibinc,iasteps,iainc,iastart
...
*     1(convary(kl),kl=1,600)
      write(15)i,j,k,l,m,wndspeed,xh*height,yh*height,A,B,Pdel
     1 t,(convary(kl),kl=1,600)
